...
import { authGuard, publicUnwrapGuard } from './guards/auth.guards';
...
export const appRoutes: Routes = [
  ...
  { path: 'create-whisper', canActivate: [authGuard], loadComponent: () => import('./pages/create-whisper.page').then(m => m.CreateWhisperPage) },
  { path: 'review-whisper', canActivate: [authGuard], loadComponent: () => import('./pages/review-whisper.page').then(m => m.ReviewWhisperPage) },

const AUTH_ERROR_MESSAGES: Record<string, string> = {
  ...
  'auth/operation-not-allowed': 'This sign-in method is not enabled for this Firebase project. Ask an administrator to enable it in Firebase Authentication > Sign-in method.',
